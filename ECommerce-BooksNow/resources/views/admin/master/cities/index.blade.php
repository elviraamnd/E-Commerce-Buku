        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 p-l-0 title-margin-left">
                    ...
                    <a class="btn btn-primary btn-flat btn-addon float-right" href="{{ route('admin.cities.create', ['id' => $id]) }}">
                        <i class="ti-plus"></i>
                        Tambah</a>
                </div>
                <!-- /# column -->
                                    ...
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $datas->postal_code }}</td>
                                                <td>{{ $datas->created_at }}</td>
                                                <td>{{ $datas->updated_at }}</td>
                                                <td>
                                                    <a class="btn btn-warning btn-flat btn-addon" href="{{ route('admin.cities.edit', ['kode' => $datas->id, 'id' => $id]) }}">
                                                        <i class="ti-pencil"></i>
                                                        Edit</a>
